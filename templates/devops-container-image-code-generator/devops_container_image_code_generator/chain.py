...
def runnable_fnd_lang_dep_mfst_dep_mgmt_tool(text: str, config: RunnableConfig):
    """
...
def route_to_find_middleware_chain(info: str, config: RunnableConfig):
    """
...
def route_to_generate_container_image_code_chain(info, config: RunnableConfig):
    """
